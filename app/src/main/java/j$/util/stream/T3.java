...
final class T3 extends AbstractC5918b0 implements c4 {
    @Override // j$.util.stream.AbstractC5917b
    final Spliterator O(AbstractC5917b abstractC5917b, Spliterator spliterator) {
        return EnumC5931d3.ORDERED.n(abstractC5917b.J()) ? N(abstractC5917b, spliterator, new C5933e0(10)).spliterator() : new h4((j$.util.Y) abstractC5917b.W(spliterator), 0);
    }
    ...
    final InterfaceC5985o2 Q(int i8, InterfaceC5985o2 interfaceC5985o2) {
        return new S3(this, interfaceC5985o2, false);
    }

    @Override // j$.util.stream.c4
    public final d4 j(C0 c02, boolean z7) {
        return new S3(this, c02, z7);
    }
}
