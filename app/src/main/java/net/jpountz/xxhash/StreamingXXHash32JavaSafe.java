...
final class StreamingXXHash32JavaSafe extends AbstractStreamingXXHash32Java {
    ...
    static class Factory implements StreamingXXHash32.Factory {
        ...
        public StreamingXXHash32 newStreamingHash(int i8) {
            return new StreamingXXHash32JavaSafe(i8);
        }
    }

    StreamingXXHash32JavaSafe(int i8) {
        super(i8);
    }
    ...
    public int getValue() {
        ...
        while (i8 <= this.memSize - 4) {
            rotateLeft = Integer.rotateLeft(rotateLeft + (SafeUtils.readIntLE(this.memory, i8) * (-1028477379)), 17) * 668265263;
            i8 += 4;
        }
        while (i8 < this.memSize) {
            rotateLeft = Integer.rotateLeft(rotateLeft + ((SafeUtils.readByte(this.memory, i8) & 255) * 374761393), 11) * (-1640531535);
            i8++;
        }
    ...
    public void update(byte[] bArr, int i8, int i9) {
        ...
        if (i10 > 0) {
            ...
            int readIntLE = this.f39800v1 + (SafeUtils.readIntLE(this.memory, 0) * (-2048144777));
            this.f39800v1 = readIntLE;
            this.f39800v1 = Integer.rotateLeft(readIntLE, 13) * (-1640531535);
            int readIntLE2 = this.f39801v2 + (SafeUtils.readIntLE(this.memory, 4) * (-2048144777));
            this.f39801v2 = readIntLE2;
            this.f39801v2 = Integer.rotateLeft(readIntLE2, 13) * (-1640531535);
            int readIntLE3 = this.f39802v3 + (SafeUtils.readIntLE(this.memory, 8) * (-2048144777));
            this.f39802v3 = readIntLE3;
            this.f39802v3 = Integer.rotateLeft(readIntLE3, 13) * (-1640531535);
            int readIntLE4 = this.f39803v4 + (SafeUtils.readIntLE(this.memory, 12) * (-2048144777));
        ...
        while (i8 <= i12) {
            i13 = Integer.rotateLeft(i13 + (SafeUtils.readIntLE(bArr, i8) * (-2048144777)), 13) * (-1640531535);
            i14 = Integer.rotateLeft(i14 + (SafeUtils.readIntLE(bArr, i8 + 4) * (-2048144777)), 13) * (-1640531535);
            i15 = Integer.rotateLeft(i15 + (SafeUtils.readIntLE(bArr, i8 + 8) * (-2048144777)), 13) * (-1640531535);
