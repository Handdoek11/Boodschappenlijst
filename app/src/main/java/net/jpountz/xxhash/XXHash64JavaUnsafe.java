...
final class XXHash64JavaUnsafe extends XXHash64 {
    ...
    public long hash(byte[] bArr, int i8, int i9, long j8) {
        ...
        if (i9 >= 32) {
            ...
            long j16 = j8;
            while (true) {
                rotateLeft = Long.rotateLeft(j15 + (UnsafeUtils.readLongLE(bArr, i11) * j11), 31) * j12;
                i10 = i12;
                rotateLeft2 = Long.rotateLeft(j14 + (UnsafeUtils.readLongLE(bArr, i11 + 8) * j11), 31) * j12;
                rotateLeft3 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr, i11 + 16) * (-4417276706812531889L)) + j16, 31) * (-7046029288634856825L);
                rotateLeft4 = Long.rotateLeft(j13 + (UnsafeUtils.readLongLE(bArr, i11 + 24) * (-4417276706812531889L)), 31);
        ...
        long j17 = j9 + i9;
        while (i11 <= i10 - 8) {
            j17 = (Long.rotateLeft(j17 ^ (Long.rotateLeft(UnsafeUtils.readLongLE(bArr, i11) * (-4417276706812531889L), 31) * (-7046029288634856825L)), 27) * (-7046029288634856825L)) - 8796714831421723037L;
            i11 += 8;
        }
        if (i11 <= i10 - 4) {
            j17 = (Long.rotateLeft(j17 ^ ((UnsafeUtils.readIntLE(bArr, i11) & 4294967295L) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i11 += 4;
        }
        int i14 = i10;
        while (i11 < i14) {
            j17 = Long.rotateLeft(j17 ^ ((UnsafeUtils.readByte(bArr, i11) & 255) * 2870177450012600261L), 11) * (-7046029288634856825L);
            i11++;
        }
