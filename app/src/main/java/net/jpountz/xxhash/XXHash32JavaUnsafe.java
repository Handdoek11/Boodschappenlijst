...
final class XXHash32JavaUnsafe extends XXHash32 {
    ...
    public int hash(byte[] bArr, int i8, int i9, int i10) {
        ...
        if (i9 >= 16) {
            ...
            do {
                i14 = Integer.rotateLeft(i14 + (UnsafeUtils.readIntLE(bArr, i8) * (-2048144777)), 13) * (-1640531535);
                i15 = Integer.rotateLeft(i15 + (UnsafeUtils.readIntLE(bArr, i8 + 4) * (-2048144777)), 13) * (-1640531535);
                i10 = Integer.rotateLeft(i10 + (UnsafeUtils.readIntLE(bArr, i8 + 8) * (-2048144777)), 13) * (-1640531535);
        ...
        int i17 = i11 + i9;
        while (i8 <= i12 - 4) {
            i17 = Integer.rotateLeft(i17 + (UnsafeUtils.readIntLE(bArr, i8) * (-1028477379)), 17) * 668265263;
            i8 += 4;
        }
        while (i8 < i12) {
            i17 = Integer.rotateLeft(i17 + ((UnsafeUtils.readByte(bArr, i8) & 255) * 374761393), 11) * (-1640531535);
            i8++;
        }
