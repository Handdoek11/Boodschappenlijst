...
final class StreamingXXHash64JavaSafe extends AbstractStreamingXXHash64Java {
    ...
    StreamingXXHash64JavaSafe(long j8) {
        super(j8);
    }
    ...
    public long getValue() {
        ...
        while (true) {
            ...
            j12 = (Long.rotateLeft(j12 ^ (Long.rotateLeft(SafeUtils.readLongLE(this.memory, i9) * (-4417276706812531889L), 31) * (-7046029288634856825L)), 27) * (-7046029288634856825L)) - 8796714831421723037L;
            i9 += 8;
        }
        if (i9 <= i8 - 4) {
            j12 = (Long.rotateLeft(j12 ^ ((SafeUtils.readIntLE(this.memory, i9) & 4294967295L) * (-7046029288634856825L)), 23) * (-4417276706812531889L)) + 1609587929392839161L;
            i9 += 4;
        }
    ...
    public void update(byte[] bArr, int i8, int i9) {
        ...
        if (i11 > 0) {
            ...
            long readLongLE = this.f39804v1 + (SafeUtils.readLongLE(this.memory, 0) * (-4417276706812531889L));
            this.f39804v1 = readLongLE;
            this.f39804v1 = Long.rotateLeft(readLongLE, 31) * (-7046029288634856825L);
            long readLongLE2 = this.f39805v2 + (SafeUtils.readLongLE(this.memory, 8) * (-4417276706812531889L));
            this.f39805v2 = readLongLE2;
            this.f39805v2 = Long.rotateLeft(readLongLE2, 31) * (-7046029288634856825L);
            long readLongLE3 = this.f39806v3 + (SafeUtils.readLongLE(this.memory, 16) * (-4417276706812531889L));
            this.f39806v3 = readLongLE3;
            this.f39806v3 = Long.rotateLeft(readLongLE3, 31) * (-7046029288634856825L);
            long readLongLE4 = this.f39807v4 + (SafeUtils.readLongLE(this.memory, 24) * (-4417276706812531889L));
        ...
        while (i10 <= i14) {
            j8 = Long.rotateLeft(j8 + (SafeUtils.readLongLE(bArr, i10) * (-4417276706812531889L)), i13) * (-7046029288634856825L);
            j9 = Long.rotateLeft(j9 + (SafeUtils.readLongLE(bArr, i10 + 8) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            j10 = Long.rotateLeft(j10 + (SafeUtils.readLongLE(bArr, i10 + 16) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            i13 = 31;
            j11 = Long.rotateLeft(j11 + (SafeUtils.readLongLE(bArr, i10 + 24) * (-4417276706812531889L)), 31) * (-7046029288634856825L);
            i10 += 32;
        }
        this.f39804v1 = j8;
        this.f39805v2 = j9;
