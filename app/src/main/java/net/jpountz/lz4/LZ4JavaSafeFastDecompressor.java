...
final class LZ4JavaSafeFastDecompressor extends LZ4FastDecompressor {
    ...
    public int decompress(byte[] bArr, int i8, byte[] bArr2, int i9, int i10) {
        ...
        if (i10 == 0) {
            if (SafeUtils.readByte(bArr, i8) == 0) {
                return 1;
            }
        ...
        int i15 = i9;
        while (true) {
            byte readByte3 = SafeUtils.readByte(bArr, i14);
            int i16 = i14 + 1;
            int i17 = (readByte3 & 255) >>> 4;
            if (i17 == 15) {
                while (true) {
                    i12 = i16 + 1;
                    readByte2 = SafeUtils.readByte(bArr, i16);
                    if (readByte2 != -1) {
                        break;
                    }
                    i17 += 255;
            ...
            if (i18 > i19) {
                if (i18 == i13) {
                    LZ4SafeUtils.safeArraycopy(bArr, i16, bArr2, i15, i17);
                    return (i16 + i17) - i8;
                }
                throw new LZ4Exception("Malformed input at " + i16);
            }
            LZ4SafeUtils.wildArraycopy(bArr, i16, bArr2, i15, i17);
            int i20 = i16 + i17;
            int readShortLE = SafeUtils.readShortLE(bArr, i20);
            i14 = i20 + 2;
            ...
            int i24 = i18 + i23;
            if (i24 <= i19) {
                LZ4SafeUtils.wildIncrementalCopy(bArr2, i21, i18, i24);
            } else {
                if (i24 > i13) {
                    throw new LZ4Exception("Malformed input at " + i14);
                }
                LZ4SafeUtils.safeIncrementalCopy(bArr2, i21, i18, i23);
            }
            i15 = i24;
        }
    }
