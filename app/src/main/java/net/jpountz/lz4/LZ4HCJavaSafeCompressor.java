    ...
    */
    ...
    private class HashTable {
        ...
        private void addHash(byte[] bArr, int i8) {
            addHash(SafeUtils.readInt(bArr, i8), i8);
        }

        private int hashPointer(byte[] bArr, int i8) {
            return hashPointer(SafeUtils.readInt(bArr, i8));
        }
        ...
        boolean insertAndFindBestMatch(byte[] bArr, int i8, int i9, LZ4Utils.Match match) {
            ...
            if (hashPointer < i8 - 4 || hashPointer > i8 || hashPointer < this.base) {
                ...
                if (LZ4SafeUtils.readIntEquals(bArr, hashPointer, i8)) {
                    i10 = i8 - hashPointer;
                    i11 = LZ4SafeUtils.commonBytes(bArr, hashPointer + 4, i8 + 4, i9) + 4;
                    match.len = i11;
            ...
            for (int i12 = 0; i12 < LZ4HCJavaSafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, i8 - MASK) && hashPointer <= i8; i12++) {
                if (LZ4SafeUtils.readIntEquals(bArr, hashPointer, i8) && (commonBytes = LZ4SafeUtils.commonBytes(bArr, hashPointer + 4, i8 + 4, i9) + 4) > match.len) {
                    match.ref = hashPointer;
            ...
            if (i11 != 0) {
                ...
                do {
                    this.chainTable[i8 & MASK] = (short) i10;
                    this.hashTable[LZ4Utils.hashHC(SafeUtils.readInt(bArr, i8))] = i8;
                    i8++;
                } while (i8 < i13);
        ...
        boolean insertAndFindWiderMatch(byte[] bArr, int i8, int i9, int i10, int i11, LZ4Utils.Match match) {
            ...
            for (int i12 = 0; i12 < LZ4HCJavaSafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, i8 - MASK) && hashPointer <= i8; i12++) {
                if (LZ4SafeUtils.readIntEquals(bArr, hashPointer, i8)) {
                    int commonBytes = LZ4SafeUtils.commonBytes(bArr, hashPointer + 4, i8 + 4, i10) + 4;
                    int commonBytesBackward = LZ4SafeUtils.commonBytesBackward(bArr, hashPointer, i8, this.base, i9);
    ...
    LZ4HCJavaSafeCompressor(int i8) {
