...
public class C0858s extends MultiAutoCompleteTextView implements androidx.core.widget.k {

    /* renamed from: u, reason: collision with root package name */
    private static final int[] f7929u = {R.attr.popupBackground};

    /* renamed from: o, reason: collision with root package name */
    private final C0845e f7930o;

    /* renamed from: s, reason: collision with root package name */
    private final C f7931s;

    /* renamed from: t, reason: collision with root package name */
    private final C0853m f7932t;
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f7931s.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f7931s.k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f7932t.d(AbstractC0855o.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f7932t.a(keyListener));
    }
    ...
    public C0858s(Context context, AttributeSet attributeSet, int i8) {
        ...
        f0 v7 = f0.v(getContext(), attributeSet, f7929u, i8, 0);
        if (v7.s(0)) {
