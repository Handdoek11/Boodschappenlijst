...
public abstract class c {
    ...
    private static final ThreadLocal f9069a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f9070b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f9069a;
        ...
        ThreadLocal threadLocal2 = f9070b;
