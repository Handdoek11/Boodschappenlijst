...
public final class h2 {
    ...
    private static h2 f973b;

    /* renamed from: c, reason: collision with root package name */
    static final byte[] f974c;

    /* renamed from: d, reason: collision with root package name */
    static final byte[] f975d;
    ...
    static final boolean c(PackageInfo packageInfo, boolean z7) {
        if (packageInfo.signatures.length == 1) {
            return z7 ? d(packageInfo, f974c, f975d) : d(packageInfo, f974c);
        }
    ...
    public final boolean b() {
        ...
        boolean z7;
        try {
            packageInfo = h3.e.a(this.f976a).f("com.google.android.wearable.app.cn", 64);
        } catch (PackageManager.NameNotFoundException unused) {
            packageInfo = null;
        }
        if (packageInfo != null) {
            if (AbstractC1110i.honorsDebugCertificates(this.f976a)) {
                z7 = c(packageInfo, true);
            } else {
                boolean c8 = c(packageInfo, false);
                if (c8 || !c(packageInfo, true)) {
                    z7 = c8;
                } else {
