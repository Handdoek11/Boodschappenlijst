    ...
    */
    public static int g(int r6, byte[] r7, int r8, int r9) {
        ...
        L86:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.r.g(int, byte[], int, int):int");
    }
    ...
    private static int i(byte[] bArr, int i8, int i9) {
        while (i8 < i9) {
            int i10 = i8 + 1;
            byte b8 = bArr[i8];
            if (b8 < 0) {
