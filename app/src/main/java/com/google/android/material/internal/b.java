...
public abstract class b {
    ...
    private static final ThreadLocal f32104a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f32105b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f32104a;
        ...
        ThreadLocal threadLocal2 = f32105b;
