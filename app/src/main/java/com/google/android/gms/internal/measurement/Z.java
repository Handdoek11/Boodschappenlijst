...
public enum Z {
    ...
    private static final Map f29071G0 = new HashMap();
    ...
    static {
        for (Z z7 : values()) {
            f29071G0.put(Integer.valueOf(z7.f29126o), z7);
        }
    }
    ...
    public static Z a(int i8) {
        return (Z) f29071G0.get(Integer.valueOf(i8));
    }

    @Override // java.lang.Enum
    public final String toString() {
        return Integer.valueOf(this.f29126o).toString();
    }
}
